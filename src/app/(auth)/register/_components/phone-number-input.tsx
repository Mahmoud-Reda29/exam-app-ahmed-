      ...
      return (
        <RPNInput.default
          ...
          className={cn(
            ...
            error
              ? "border-red-500"
              : "border-gray-300 focus-within:border-blue-600 hover:border-blue-700",
            className
          )}
...
>(({ className, ...props }, ref) => (
  <Input
    className={cn(
      "rounded-e-lg rounded-s-none border-0 focus:ring-0 focus-visible:ring-0 ",
      className
    )}
    {...props}
    ref={ref}
    ...
    >
      <PopoverTrigger asChild className=" h-12">
        <Button
          type="button"
          variant="outline"
          className="flex gap-1 rounded-s-lg rounded-none border-0 px-3 focus:z-10  "
          disabled={disabled}
        >
          <FlagComponent
      ...
      <PopoverContent className="w-72 p-0 bg-white shadow-lg  border-0 rounded-lg">
        <Command>
          <CommandInput
            value={searchValue}
            onValueChange={(value) => {
